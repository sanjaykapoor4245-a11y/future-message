...
import type { Capsule as _Capsule, Cell as _Cell, Error as _Error, Result as _Result, Result__1 as _Result__1, UserRole as _UserRole, Value as _Value } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createCapsule(arg0: string, arg1: string, arg2: bigint): Promise<Capsule> {
        if (this.processError) {
            try {
                const result = await this.actor.createCapsule(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCapsule(arg0: CapsuleId): Promise<Capsule | null> {
        if (this.processError) {
            try {
    ...
    async listCapsules(): Promise<Array<Capsule>> {
        if (this.processError) {
            try {
                const result = await this.actor.listCapsules();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Capsule]): Capsule | null {
